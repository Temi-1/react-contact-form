...
export default function LinkSection() {
  return (
    <div className="links">
        ...
        <a id="book_python" href="https://books.zuri.team/python-for-beginners?ref_id=TemiA">Python for Dummies</a>
        <a id="pitch" href="https://background.zuri.team">Unearth that coder's past now!</a>
